...
C.AMPLITUDE_RANGE     = [0 10];                 % [min max] uA
C.STA_REPS_PER_SET        = 30;
...
% NIP CONFIG 
% =========================================================================
nanostim_location = {'DRG - S1', 'DRG - S2', 'DRG - S3', 'Epidural'};
nanostim_chanOrder = {129:160, 161:192, 193:224, 129:144};
