...
% Channels to test
stim_channels = C.NANOSTIM_ACTIVE_CHAN;
...
% if save_figs
%     a = fileparts(protocol.workingDirectory);
%     savefig(protocol.figH, fullfile(a, sprintf('maxAmpSurvey%d.fig', length(dir([a, 'maxAmpSurvey*'])))))
%     savefig(protocol.legendH, fullfile(a, sprintf('maxAmpLegend%d.fig', length(dir([a, 'maxAmpSurvey*'])))))
% end
