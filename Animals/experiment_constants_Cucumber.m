function C = experiment_constants_Cucumber
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Cucumber';   % Animal name
C.STIMULATOR_TYPE     = 'Grapevine';
C.SURGERY_DATE        = '2021-04-06'; %YYYY-MM-DD
...
C.ANALOG_CHAN         = {'Bladder', '0', '0', '0', 'LegX', 'LegY', 'LegZ', '0', '0'};  %'UrineScale'
%C.ANALOG_CHAN         = {'Bladder', '0', '0', '0', 'LitterX', 'LitterY', 'LitterZ', 'InfusionPump', 'UrineScale'};
