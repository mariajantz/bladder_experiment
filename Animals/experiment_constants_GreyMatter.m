function C = experiment_constants_GreyMatter
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'GreyMatter';   % Animal name
...
C.STIM_POLARITY       = 1;              % 0 - negative (cathodic) phase first, 1 - positive (anodic) phase first 
...
% C.STIM_MAP            = num2cell([[2 4:6 9:14 17:18 20 22]' [[2 4:6 9:14 17:18 20 22] + 2]']); % BIPOLAR _WIDE HORIZONTAL
%-------------------------------------------------------------------------------------------------------------
