function C = experiment_constants_Grindelwald
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Grindelwald';   % Animal name
...
% =========================================================================
C.MAX_AMP             = 3000;            % maximum amplitude stimulation on cathode in uA
...
% C.STIM_MAP            = num2cell([[1:6 9:14 17:22]' [[1:6 9:14 17:22] + 2]']); % BIPOLAR _WIDE HORIZONTAL
%-------------------------------------------------------------------------------------------------------------
