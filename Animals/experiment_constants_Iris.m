function C = experiment_constants_Iris
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Iris';   % Animal name
C.STIMULATOR_TYPE     = 'Grapevine';
C.ARRAY_TYPE          = 'Blackrock';       % Brand of array, ie 'MicroLeads', 'Ripple', 'Blackrock'
C.LOCATION            = 'DRG - S3';     % Options: 'DRG - S1', 'Epidural - L6', etc
...
C.STIM_HEADSTAGE_LOC  = 'B3';           % Trellis value of stim headstage, options 'B1'/'B2'/'B3'
...
% =========================================================================
C.MAX_AMP             = 70;            % maximum amplitude stimulation on cathode in uA
...
% ANALYSIS PARAMETERS 
% =========================================================================
C.AMP_MIN_DIFF = 1; % uA; this determines step size in binary search 
C.AMP_MAX_DIFF = 10; 
