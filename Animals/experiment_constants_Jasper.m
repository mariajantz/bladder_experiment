function C = experiment_constants_Jasper
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Jasper';   % Animal name
...
C.DIG_TRIGGER_CHAN    = 1;              % if using digital triggering, set this channel number
C.STIM_PW_MS          = 1.4;            % pulse width, in ms - currently cathode and anode
...
%-------------------------------------------------------------------------------------------------
% C.STIM_MAP            = num2cell([1:10 12:16; 9:18 20:24]'); % BIPOLAR VERTICAL
%-------------------------------------------------------------------------------------------------
