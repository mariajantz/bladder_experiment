function C = experiment_constants_Jorkins
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Jorkins';   % Animal name
C.STIMULATOR_TYPE     = 'Grapevine';
C.ARRAY_TYPE          = 'Ripple';       % Brand of array, ie 'MicroLeads', 'Ripple', 'Blackrock'
C.LOCATION            = 'Epidural - Clinical';     % Options: 'DRG - S1', 'Epidural - L6', etc
...
C.HIGHAMP_HEADSTAGE_LOC = 'D';         % if using two headstages to stimulate, include this - otherwise, leave as empty string ''
...
%C.STIM_MAP = num2cell(1:16)'; % MONOPOLAR 
%-------------------------------------------------------------------------------------------------
% C.STIM_MAP            = num2cell([setdiff([1:31], [4:4:32]); setdiff(2:32, 1:4:29)]'); %BIPOLAR HORIZONTAL
%-------------------------------------------------------------------------------------------------
C.STIM_MAP            = num2cell([1:15; 2:16]'); % BIPOLAR VERTICAL
%-------------------------------------------------------------------------------------------------
...
C.MIN_RESPONSE_LATENCY     = 1.5e-3; %has to be > PWcath+PWanode+IPI (default IPI 66us)
