function C = experiment_constants_Labatt
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Labatt';   % Animal name
...
%-------------------------------------------------------------------------------------------------------------
 C.STIM_MAP            = num2cell([[1:2:16]' [[1:2:16] + 8]']); %BIPOLAR VERTICAL
%-------------------------------------------------------------------------------------------------------------
...
C.MIN_RESPONSE_LATENCY     = 1e-3; %has to be > PWcath+PWanode+IPI (default IPI 66us) - blank time
