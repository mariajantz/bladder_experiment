function C = experiment_constants_Longbottom
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Longbottom';   % Animal name
...
% =========================================================================
C.MAX_AMP             = 300;            % maximum amplitude stimulation on cathode in uA
...
%-------------------------------------------------------------------------------------------------
C.STIM_MAP             = num2cell([1:12; 5:16]'); % BIPOLAR VERTICAL
%-------------------------------------------------------------------------------------------------
