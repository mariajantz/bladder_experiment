function C = experiment_constants_Malfoy
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Malfoy';   % Animal name
C.STIMULATOR_TYPE     = 'Grapevine';
C.ARRAY_TYPE          = 'Ripple';       % Brand of array, ie 'MicroLeads', 'Ripple', 'Blackrock'
C.LOCATION            = 'Epidural - S1_cauda_dissection';     % Options: 'DRG - S1', 'Epidural - L6', etc
...
C.STIM_FREQUENCY      = [33 100];       % first (low) freq used for high amp survey to capture 
