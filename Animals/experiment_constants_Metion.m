function C = experiment_constants_Metion
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Metion';   % Animal name
C.STIMULATOR_TYPE     = 'Grapevine';
C.ARRAY_TYPE          = 'Custom';       % Brand of array, ie 'MicroLeads', 'Ripple', 'Blackrock'
C.LOCATION            = 'Rootlet - S3';     % Options: 'DRG - S1', 'Epidural - L6', etc
...
C.LAYOUT_MAP          = ([1:2:15 2:2:16]);   %microleads
...
%====================================STIMULATION TYPES============================================
%Tyler's nifty custom array
%C.STIM_MAP = num2cell(1:16)'; %MONOPOLAR
%C.STIM_MAP = num2cell([[1:8]; [9:16]]'); %BIPOLAR DIFF COLOR
C.STIM_MAP = num2cell([[1:2:15]; [2:2:16]]'); %BIPOLAR SAME COLOR
