function C = experiment_constants_Molson
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Molson';   % Animal name
C.STIMULATOR_TYPE     = 'Grapevine';
C.ARRAY_TYPE          = 'MicroLeads MUX';       % Brand of array, ie 'MicroLeads', 'Ripple', 'Blackrock'
...
C.LAYOUT_MAP          = [17 6 14 11 1 8; 27 15 4 3 10 18; 31 7 13 12 0 28;...
                            37 16 5 2 9 32; 43 42 26 19 39 38];
