...
% C.LAYOUT_MAP          = [17 6 14 11 1 8; 27 15 4 3 10 18; 31 7 13 12 0 28;...
%                              37 16 5 2 9 32; 43 42 26 19 39 38; 41 30 23 22 29 40; 46 35 24 21 34 45; 51 36 25 20 33 50];
C.LAYOUT_MAP = [1:6; 7:12]; 
...
C.STIM_MAP = num2cell([1 2 5 6 8 11])';
%-------------------------------------------------------------------------------------------------------------
...
% C.STIM_MAP            = num2cell([8 16; 14 22; 6 14; 15 23; 16 24]); 
%-------------------------------------------------------------------------------------------------------------
