...
function C = experiment_constants_Neville
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Neville';   % Animal name
C.STIMULATOR_TYPE     = 'Grapevine';
C.ARRAY_TYPE          = 'Ripple';       % Brand of array, ie 'MicroLeads', 'Ripple', 'Blackrock'
C.LOCATION            = 'Epidural - S1_SCI';     % Options: 'DRG - S1', 'Epidural - L6', etc
...
% =========================================================================
C.MAX_AMP             = 250;            % maximum amplitude stimulation on cathode in uA
...
C.RMS_THRESHOLD_MULTIPLIER = 3.2; %how high above threshold must something be to register as a response
