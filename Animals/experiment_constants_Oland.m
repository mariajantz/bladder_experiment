...
%C.STIM_MAP = num2cell([[1:15]' [2:16]']);
C.STIM_MAP = num2cell([1:16])'; 
%-------------------------------------------------------------------------------------------------------------
