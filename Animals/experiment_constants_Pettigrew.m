function C = experiment_constants_Pettigrew
% =========================================================================
% ANIMAL AND HEADSTAGE BACKGROUND
% =========================================================================
C.CAT_NAME            = 'Pettigrew';   % Animal name
...
%C.NOTES               = 'Electrode is ROTATED 180 at L5 so wire bundle comes out caudal';
...
% =========================================================================
C.MAX_AMP             = 75;            % maximum amplitude stimulation on cathode in uA
