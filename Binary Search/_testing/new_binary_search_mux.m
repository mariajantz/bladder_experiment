...
%files)
[stim_freqs, response_locs] = high_amplitude_survey_mux(C, savepath, datapath, baselinefile, 'testing', ~stim_on, 'survey_filenum', surveyfile, 'plotting', true);
