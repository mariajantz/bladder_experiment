function chanSnips = max_amp_split(C, filepath, varargin)
...
%find the correct number of events, sometimes off by one (TODO: test!)
%TODO: doesn't work for multipolar at least...
%TODO: for now this seems to be unnecessary but fix it as a check later?
% for i = -1:1
%     if any(C.MAX_AMP_REPS + i == numEvts)
%         evtIdx = find(C.MAX_AMP_REPS + i == numEvts);
%     end
% end
