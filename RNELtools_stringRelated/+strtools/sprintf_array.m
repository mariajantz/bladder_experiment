function output = sprintf_array(format,varargin)
%sprintf_array  Each index of the input arrays is put into a sprintf command
%
%   output = strtools.sprintf_array(format,varargin)
%
...
%   EXAMPLES:
%   ====================================================
%   output = strtools.sprintf_array('%d-%d',1:4,2:5)
%   output => 
%       {'1-2'    '2-3'    '3-4'    '4-5'}
%
%
%   output = strtools.sprintf_array('%d-%s',1:4,{'a' 'b' 'c' 'd'})
%   output =>
%    '1-a'    '2-b'    '3-c'    '4-d'
