% initialize xippmex
status = xippmex;  
if status == 1; disp('xippmex connected successfully'); end
if status ~= 1; error('Xippmex fail to initialize');  end
...
electrode = [51,46];
ripple_ch = mux_connect(electrode)


% use ripple_ch to turn on stimulation on ripple channels
